...
class BeamCTCDecoder(Decoder):
    ...
    def decode(self, probs, sizes=None):
        ...
        """
        probs = probs.cpu()
        # print('probs.cpu_size:', probs.size(), flush=True)
        # print(0,type(probs),1,type(sizes))
        # np.save("/data2/users/lvxuan/basecall/data/test/output/probs.npy",probs)
        out, scores, offsets, seq_lens = self._decoder.decode(probs, sizes)
        # print("decode_out_size:",out.size()) #lx:(sum(row_num),3,512)
