...
class TrainBatchProvider():
    def __init__(self, dataset, batch_size, num_workers, train_sampler, pin_memory=True,shuffle=False):
    ...
    def build(self):
        dataloader = Data.DataLoader(
            self.dataset, batch_size=1, shuffle=self.shuffle,num_workers=self.workers, pin_memory=self.pin_memory,sampler=self.sampler)
